...
namespace PHASE_END_PROJECT_3.Controllers
{
    public class UserInfoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserId,Email,Password")] UserInfo userInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,Email,Password")] UserInfo userInfo)
        {
            if (ModelState.IsValid)
            {
